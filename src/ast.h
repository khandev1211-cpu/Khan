...
struct AstNode {
    ...
    union {
        ...
        // AST_PRINT_STMT / AST_RETURN_STMT / AST_EXPR_STMT / AST_THROW_STMT
        AstNode *expr;
        ...
        // AST_TRY_STMT — try: <try_block> catch [name]: <catch_block>
        struct {
            AstNode *try_block;
            const char *catch_var;   // may be NULL for bare "catch:"
            AstNode *catch_block;
        } try_stmt;
